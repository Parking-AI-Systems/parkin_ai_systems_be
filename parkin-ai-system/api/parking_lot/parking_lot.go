...
type IParkingLotParking_lot interface {
	...
	ParkingLotGet(ctx context.Context, req *parking_lot.ParkingLotGetReq) (res *parking_lot.ParkingLotGetRes, err error)
	...
	ParkingLotImageDelete(ctx context.Context, req *parking_lot.ParkingLotImageDeleteReq) (res *parking_lot.ParkingLotImageDeleteRes, err error)
}
