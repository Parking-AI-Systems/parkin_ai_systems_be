...
func (s *sOthersServiceOrder) OthersServiceOrderAddWithUser(ctx context.Context, req *entity.OthersServiceOrderAddReq) (*entity.OthersServiceOrderAddRes, error) {
	...
	if err != nil {
		return nil, gerror.NewCode(consts.CodeDatabaseError, "Unable to verify the vehicle. Please try again later.")
	}
	if vehicle.IsEmpty() {
	...
	if err != nil {
		return nil, gerror.NewCode(consts.CodeDatabaseError, "Unable to verify the parking lot. Please try again later.")
	}
	if lot.IsEmpty() {
	...
	if err != nil {
		return nil, gerror.NewCode(consts.CodeDatabaseError, "Unable to verify the service. Please try again later.")
	}
	if service.IsEmpty() {
...
func (s *sOthersServiceOrder) OthersServiceOrderUpdate(ctx context.Context, req *entity.OthersServiceOrderUpdateReq) (*entity.OthersServiceOrderItem, error) {
	...
	if err != nil {
		return nil, gerror.NewCode(consts.CodeDatabaseError, "Unable to load the order. Please try again later.")
	}
	if order.IsEmpty() {
		return nil, gerror.NewCode(consts.CodeNotFound, "Service order not found.")
	}
	if !isAdmin && gconv.Int64(order.Map()["user_id"]) != gconv.Int64(userID) {
		return nil, gerror.NewCode(consts.CodeUnauthorized, "Only admins or the order owner can update this order.")
	}
...
func (s *sOthersServiceOrder) OthersServiceOrderCancel(ctx context.Context, req *entity.OthersServiceOrderCancelReq) (*entity.OthersServiceOrderItem, error) {
	...
	if !isAdmin && gconv.Int64(order.Map()["user_id"]) != gconv.Int64(userID) {
		return nil, gerror.NewCode(consts.CodeUnauthorized, "Only admins or the order owner can cancel this order.")
	}
...
func (s *sOthersServiceOrder) OthersServiceOrderDelete(ctx context.Context, req *entity.OthersServiceOrderDeleteReq) (*entity.OthersServiceOrderDeleteRes, error) {
	...
	if !isAdmin && gconv.Int64(order.Map()["user_id"]) != gconv.Int64(userID) {
		return nil, gerror.NewCode(consts.CodeUnauthorized, "Only admins or the order owner can delete this order.")
	}
...
func (s *sOthersServiceOrder) OthersServiceOrderPayment(ctx context.Context, req *entity.OthersServiceOrderPaymentReq) (*entity.OthersServiceOrderItem, error) {
	...
	if gconv.Int64(order.Map()["user_id"]) != gconv.Int64(userID) {
		return nil, gerror.NewCode(consts.CodeUnauthorized, "Only the order owner can process this payment.")
	}
	...
	}).Where("id", userID).Where("deleted_at IS NULL").Update()
	if err != nil {
